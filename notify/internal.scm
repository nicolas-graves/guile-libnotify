...
(define g-variant-new
  (foreign-library-function "libglib-2.0" "g_variant_new"
                            #:return-type '*
                            #:arg-types (list '* '*)))
...
(define g-variant-new-string
  (foreign-library-function "libglib-2.0" "g_variant_new_string"
                            #:return-type '*
                            #:arg-types (list '*)))

(define g-variant-unref
  (foreign-library-function "libglib-2.0" "g_variant_unref"
                            #:return-type void
                            #:arg-types (list '*)))
